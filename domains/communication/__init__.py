"""Communication sub-domain: tactical radio, HF/VHF/UHF comms, software-defined radios."""
import json
from pathlib import Path
from typing import Optional

from domains._schema import Part, Question
from domains.communication.questions import COMMUNICATION_QUESTIONS
from domains.communication.prompts import COMMUNICATION_SYSTEM_PROMPT_ADDITION
...
def get_questions(application: Optional[str] = None) -> list[Question]:
    ...
    return [q for q in COMMUNICATION_QUESTIONS if not q.triggers or application in q.triggers]
...
def get_system_prompt_addition() -> str:
    return COMMUNICATION_SYSTEM_PROMPT_ADDITION
